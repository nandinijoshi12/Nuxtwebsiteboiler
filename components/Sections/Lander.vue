<template>
    <div class="relative h-auto w-full text-zinc-400 flex flex-col">
        ...
        <div  class="relative z-20 flex flex-col w-full md:w-4/5 h-auto my-10 py-8 bg-zinc-900/70 backdrop-blur-sm">
            ...
            <div class="absolute w-full -300 -z-10 -top-20 overflow-hidden"><img src="https://res.cloudinary.com/dezmjeesi/image/upload/v1693047233/svg%20items/Vector_3_Stroke_rangay_bae_rangy_wb3jgz.svg" alt="" class="w-full"></div>
